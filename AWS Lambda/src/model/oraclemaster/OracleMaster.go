...
// ReportPara is a paid mutator transaction binding the contract method 0x23697b2e.
//
// Solidity: function reportPara(address _collator, uint128 _eraId, uint128 _eraNonce, (uint256,uint128,uint128,uint128,bytes32,uint128,uint128,(address,uint128,bool,uint256,uint256,(address,uint256)[])[],bool) _report) returns()
