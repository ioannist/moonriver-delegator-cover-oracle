...
//
// Solidity: function members(address ) view returns(bool isMember, bool active, uint256 deposit, uint256 maxCoveredDelegation, uint128 lastPushedEra, uint256 delegatorsReportedInEra, uint256 lastDelegationsTotall, uint128 noZeroPtsCoverAfterEra, uint128 noActiveSetCoverAfterEra, uint128 defaultCount)
func (_MoonriverDelegatorCoverOracle *MoonriverDelegatorCoverOracleCaller) Members(opts *bind.CallOpts, arg0 common.Address) (struct {
	...
	outstruct.DelegatorsReportedInEra = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
	outstruct.LastDelegationsTotall = *abi.ConvertType(out[6], new(*big.Int)).(**big.Int)
	outstruct.NoZeroPtsCoverAfterEra = *abi.ConvertType(out[7], new(*big.Int)).(**big.Int)
	outstruct.NoActiveSetCoverAfterEra = *abi.ConvertType(out[8], new(*big.Int)).(**big.Int)
	outstruct.DefaultCount = *abi.ConvertType(out[9], new(*big.Int)).(**big.Int)
