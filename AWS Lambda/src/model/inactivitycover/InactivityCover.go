...
//
// Solidity: function getMember(address member) view returns(bool, bool, uint256, uint256, uint256, uint128, uint128, uint128, uint128)
func (_MoonriverDelegatorCoverOracle *MoonriverDelegatorCoverOracleCaller) GetMember(opts *bind.CallOpts, member common.Address) (bool, bool, *big.Int, *big.Int, *big.Int, *big.Int, *big.Int, *big.Int, *big.Int, error) {
	var out []interface{}
	err := _MoonriverDelegatorCoverOracle.contract.Call(opts, &out, "getMember", member)

	if err != nil {
		return *new(bool), *new(bool), *new(*big.Int), *new(*big.Int), *new(*big.Int), *new(*big.Int), *new(*big.Int), *new(*big.Int), *new(*big.Int), err
	}
...
//
// Solidity: function getMember(address member) view returns(bool, bool, uint256, uint256, uint256, uint128, uint128, uint128, uint128)
func (_MoonriverDelegatorCoverOracle *MoonriverDelegatorCoverOracleSession) GetMember(member common.Address) (bool, bool, *big.Int, *big.Int, *big.Int, *big.Int, *big.Int, *big.Int, *big.Int, error) {
...
//
// Solidity: function getMember(address member) view returns(bool, bool, uint256, uint256, uint256, uint128, uint128, uint128, uint128)
func (_MoonriverDelegatorCoverOracle *MoonriverDelegatorCoverOracleCallerSession) GetMember(member common.Address) (bool, bool, *big.Int, *big.Int, *big.Int, *big.Int, *big.Int, *big.Int, *big.Int, error) {
	return _MoonriverDelegatorCoverOracle.Contract.GetMember(&_MoonriverDelegatorCoverOracle.CallOpts, member)
}
...
//
// Solidity: function members(address ) view returns(bool isMember, bool active, uint256 deposit, uint256 maxCoveredDelegation, uint256 delegatorsReportedInEra, uint256 lastDelegationsTotall, uint128 noZeroPtsCoverAfterEra, uint128 noActiveSetCoverAfterEra, uint128 defaultCount, uint128 lastPushedEra, uint128 wentInactiveEra)
func (_MoonriverDelegatorCoverOracle *MoonriverDelegatorCoverOracleCaller) Members(opts *bind.CallOpts, arg0 common.Address) (struct {
	...
	outstruct.DelegatorsReportedInEra = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
	...
	outstruct.LastPushedEra = *abi.ConvertType(out[9], new(*big.Int)).(**big.Int)
	outstruct.WentInactiveEra = *abi.ConvertType(out[10], new(*big.Int)).(**big.Int)
...
// PushData is a paid mutator transaction binding the contract method 0xad5eb1ab.
//
// Solidity: function pushData(uint128 _eraId, (uint256,uint128,uint128,uint128,bytes32,uint128,uint128,(address,uint128,bool,uint256,uint256,(address,uint256)[])[],bool) _report, address _oracleCollator) returns()
